            ...
            while ($query->have_posts()) {
              ...
              <ul class="footer-last-news">
                <?php if (has_post_thumbnail(get_the_ID())): ?>
                  <a href="<?php echo get_permalink(get_the_ID()); ?>?type=<?= $post_cat_slug ?>" target="_self">
                    <li>
                      <?php $news_image = wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()), 'thumbnail'); ?>
                      <img class="img-djoko" src="<?php echo $news_image[0]; ?>" alt="" width="100px" height="60px" />
                    <?php endif; ?>
                    <p>
                      <?= get_the_title() ?>
                    </p>
...
<script src="<?php echo get_template_directory_uri(); ?>/js/jquery-migrate-1.2.1.min.js"
