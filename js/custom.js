...
$(document).ready(function () {
   ...
   // Lightbox Gallery
        ...
        const lastImage = lightboxEnabled.length - 1;
        const lightboxContainer = $('.lightbox-container');
        const lightboxImage = $('.lightbox-image');
        const lightboxBtns = $('.lightbox-btn');
        const lightboxBtnRight = $('#right');
        const lightboxBtnLeft = $('#left');
        const close = $('#close');
        let activeImage;
        ...
        const transitionSlidesLeft = () => {
            ...
            setTimeout(function () {
                activeImage === 0 ? setActiveImage(lightboxEnabled.eq(lastImage)) : setActiveImage(lightboxEnabled.eq(activeImage - 1));
            }, 250);
        ...
        const transitionSlidesRight = () => {
            ...
            setTimeout(function () {
                activeImage === lastImage ? setActiveImage(lightboxEnabled.eq(0)) : setActiveImage(lightboxEnabled.eq(activeImage + 1));
            }, 250);
            setTimeout(function () {
        ...
        // Event Listeners
        lightboxEnabled.on('click', function (e) {
            e.preventDefault();
            showLightBox();
            setActiveImage($(this));
        });
    ...
    //     // Your form ID may be different
    //     var $form = $(this);

    //     // Add a loading indicator or disable the submit button here if needed

    //     // Get form data
    //     var formData = $form.serialize();

    //     // Add nonce for security
    //     formData += '&nonce=' + contact_form_vars.nonce;
