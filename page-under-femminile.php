...
<section class="drawer">
    ...
    <div class="col-md-12 size-img back-img"
        ...
        <div class="effect-cover">
            <h3 class="txt-advert animated">Under Femminile</h3>
            ...
            <div class="top-score-title right-score col-md-9">
                ...
                <div class="content-wtp-player">
                    ...
                    <div class="col-md-3 atp-player">
                        <a href="profilo_giocatore.html"><img
                                src="<?php echo get_template_directory_uri(); ?>/images/player/face.jpg" alt="" />
                            <p>LUCA BERNARDI</p>
                        </a>
                    </div>
                    <div class="col-md-3 atp-player">
            ...
            <div class="col-md-3 right-column">
                <div class="top-score-title col-md-12 right-title">
                    ...
                    <div class="right-content">
                        ...
                        <p class="txt-right">Simon, who’s seeded just a lowly 26th here, was in many ways the right man
                            for this grueling assignment</p>
